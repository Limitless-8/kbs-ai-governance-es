% Auto-generated facts for run_id=20260126_232306_refuse_jurisdiction_unclear
:- dynamic main:input/2.

main:input(uk_public_sector_applicability, unclear).
main:input(decision_impact, advisory).
main:input(consequence_severity, low).
main:input(personal_data_usage, yes).
main:input(special_category_data, no).
main:input(biometric_processing, no).
